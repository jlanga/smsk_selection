...
rule orthofinder_prepare:
    ...
    params:
        ...
        temp_dir1 = ORTHOFINDER + "OrthoFinder/",
        temp_dir2 = ORTHOFINDER + "OrthoFinder/Results_prepare/WorkingDirectory/"
    log:
